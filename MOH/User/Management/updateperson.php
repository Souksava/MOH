...
<html>
    ...
    <body >
        ...
        if(isset($_GET['id'])){
            $id = $_GET['id'];
            $sqlget = "select per_id,per_name,per_surname,gender,dob,tel,address,email,t.type_id,type_name,eth_name,nation_name,p.sec_id,sec_name,pro_name,p.nation_id,p.eth_id from personality p left join type_person t on p.type_id=t.type_id left join ethnicity c on p.eth_id=c.eth_id left join nationality n on p.nation_id=n.nation_id left join section s on p.sec_id=s.sec_id left join province o on s.province=o.pro_id where per_id='$id';";
            ...
            if(isset($_POST['btnUpdate'])){
                ...
                elseif(trim($nation_id) == ""){
                    ...
                    echo"</script>";
                        ...
                        $sqlupdateper = "update personality set per_name='$per_name',per_surname='$per_surname',gender='$gender',dob='$dob',tel='$tel',address='$address',email='$email',type_id='$type_id',eth_id='$eth_id',nation_id='$nation_id',sec_id='$sec_id' where per_id='$per_id';";
