...
function ShowData(){
    ...
    $pro_id = $_POST['pro_id'];
    if(isset($_POST['btn'])){
        $sql = "select sec_name,village,district,pro_name from section s left join province p on s.province=p.pro_id where sec_name like '$sec_name' or province = '$pro_id' order by sec_name;";
