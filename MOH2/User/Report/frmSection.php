    ...
    <div class="container font14">
        <div>
            ...
            <table>
                <tr>
                    ...
                    <form action="excel_section.php" method="POST" id="formexcel">
                        <td>
                            <input type="hidden" name="sec_name" value="<?php echo $sec_name ?>">
                            <input type="hidden" name="pro_id" value="<?php echo $pro_id ?>">
                            <button type="submit" name="btnExcel" class="btn btn-outline-success">Export to Excel</button> 
                        </td>
                        <td>
        ...
        <div class="table-responsive">
            <table class="table table-striped" style="width: 100%;">
                ...
                <?php
                    $sqlsearch = "select sec_name,village,district,pro_name from section s left join province p on s.province=p.pro_id where sec_name = '$sec_name' or province = '$pro_id' order by sec_name asc;";
        ...
        <div>
            ...
            <table>
                <tr>
                    ...
                    <form action="excel_section.php" method="POST" id="formexcel">
                        <td>
                            <button type="submit" name="btnExcel_All" class="btn btn-outline-success">Export to Excel</button>
                        </td>
                        <td>
                            <button type="submit" name="btnWord_All" class="btn btn-outline-primary">Export to Excel</button>
                        </td>
                    </form>
                </tr>
            </table>
