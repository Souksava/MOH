    ...
    <body >
                                        ...
                                        <div class="row" align="left">
                                            ...
                                            <div class="col-md-12 form-group">
                                                ...
                                                <select name="cer_id" id="" class="form-control">
                                                    ...
                                                    <?php
                                                        $sqlcer = "select cer_id,cer_name,cer_name2 from certificate c left join certificate2 c2 on c.cer_id2=c2.cer_id2 order by cer_name2 asc;";
            ...
            if(isset($_POST['btnSave'])){
                ...
                elseif(trim($cer_id) == ""){
                    ...
                    if (mysqli_num_rows($resultckname) > 0) {
                        ...
                        $sqlinsert = "insert into personality(per_id,per_name,per_surname,gender,dob,tel,address,email,type_id,eth_id,nation_id,sec_id,cer_id) values('$per_id','$per_name','$per_surname','$gender','$dob','$tel','$address','$email','$type_id','$eth_id','$nation_id','$sec_id','$cer_id');";
        ...
        <div class="container font12">
            ...
            <div class="table-responsive">
                <table class="table table-striped" style="width: 2200px;">
                    <tr>
