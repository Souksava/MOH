        ...
        <div class="container font14">
            <div class="row">
                ...
                <div style="float: right;width: 48%;padding-left: 10px;" align="right">
                    ...
                    ?>
                    <form action="traindetail.php" method="POST" id="formdelete">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <input type="hidden" name="train_id" value="<?php echo $id2; ?>">
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    </div>
                                    <div class="modal-body" align="center">
                                        ທ່ານຕ້ອງການລົບຂໍ້ມູນການຝຶກອົບຮົມ ຫຼື ບໍ່ ?
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-outline-secondary" data-dismiss="modal">ຍົກເລີກ</button>
                                        <button type="submit" name="btnDelete" class="btn btn-outline-danger" onclick="">ລົບຂໍ້ມູນ</button>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="table-responsive">
            <table class="table table-striped" style="width: 2800px;">
                ...
                <tr>
                    ...
                    <td>
                        <form action="traindetail.php" method="POST" id="frmdetail">
                            <input type="hidden" name="detail_id" value="<?php echo $row['detail_id']; ?>">
                           <button type="submit" name="btndeldetail" class="btn btn-outline-danger" onclick="">
                                ລົບຂໍ້ມູນ
                           </button>
                        </form>
